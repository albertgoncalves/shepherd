...
var YS_TO = new Float32Array(new ArrayBuffer(FLOAT32_BYTES));
var YS_FROM = new Float32Array(new ArrayBuffer(FLOAT32_BYTES));
var DELTAS = new Float32Array(new ArrayBuffer(FLOAT32_BYTES));
var DRAG = 50;
var THRESHOLD = 1;
var RESET;
